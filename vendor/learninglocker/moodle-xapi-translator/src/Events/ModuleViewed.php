...
class ModuleViewed extends CourseViewed {
    ...
    public function read(array $opts) {
        ...
        $jiscSubType = static::$xapi_type.$opts['module']->type;

        if ($opts['module']->type=='url'){
            $jiscType = 'http://xapi.jisc.ac.uk/externalURL';
        }

        if ($opts['module']->type=='lti'){
            $jiscType = 'http://xapi.jisc.ac.uk/externalContent';
        }

        if ($opts['module']->type=='scorm'){
            $jiscType = 'http://xapi.jisc.ac.uk/externalContent';
        }
