...
function xmldb_logstore_jisc_xapi_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2015081001) {
        ...
        // Define table logstore_jisc_xapi_log to be created.
        $table = new xmldb_table('logstore_jisc_xapi_log');

        // Adding fields to table logstore_jisc_xapi_log.
        ...
        // Adding keys to table logstore_jisc_xapi_log.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Adding indexes to table logstore_jisc_xapi_log.
        ...
        // Conditionally launch create table for logstore_jisc_xapi_log.
