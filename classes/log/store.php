...
namespace logstore_jisc_xapi\log;
...
class store extends php_obj implements log_writer {
    ...
    protected function is_event_ignored(event_base $event) {
          ...
          if (get_config('logstore_jisc_xapi', 'whitelistenabled')) {
              $list = ",".get_config('logstore_jisc_xapi', 'whitelist').",";
          ...
          if (get_config('logstore_jisc_xapi', 'whitelistcoursesenabled')) {
              $list = ",".get_config('logstore_jisc_xapi', 'whitelistcourses').",";
    ...
    protected function insert_event_entries(array $events) {
        ...
        if (get_config('logstore_jisc_xapi', 'backgroundmode')) {
            $DB->insert_records('logstore_jisc_xapi_log', $events);
        } else {
...
public function process_events(array $events) {
       ...
       $maxbatchsize = get_config('logstore_jisc_xapi', 'maxbatchsize');
